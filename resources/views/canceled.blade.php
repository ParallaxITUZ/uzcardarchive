...
<div class="header">
    ...
    <h2>
        Серия {{$contract->series}} <br>
        № {{str_pad($contract->number, 7, '0', STR_PAD_LEFT)}}
    </h2>
</div>
<div class="text-center">
    ...
    <table>
        ...
        <tr>
            <td colspan="2">{{$contract->client['individual']['first_name']}} {{$contract->client['individual']['last_name']}}</td>
        </tr>
        <tr>
            <th colspan="2">ADDRESS /Адрес</th>
        </tr>
        <tr>
            <td colspan="2">{{$contract->client['address']}}</td>
        </tr>
        <tr>
