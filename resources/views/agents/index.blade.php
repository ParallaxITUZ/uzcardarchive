<x-app-layout>
    ...
    <h2>{{ __('common.agents') }} <a href="{{ route('agents.create') }}" class="btn btn-primary float-end" type="button">{{ __('form.create_agent') }}</a></h2>
    <div class="card mb-4">
        <div class="card-body">
            ...
            <table class="table table-sm">
                ...
                @foreach ($pagination as $item)
                    <tr>
                        ...
                        <td class="text-end">
                            <form action="{{ route('agents.destroy', $item->id) }}" method="POST" data-confirm="Are you sure that you want to delete this?">

                                <a href="{{ route('agents.show', $item->id) }}" title="show">
                                    <i class="fas fa-eye text-success"></i>
                                </a>

                                <a href="{{ route('agents.edit', $item->id) }}">
